...
class Pintura extends StatefulWidget {
  const Pintura({super.key});

  @override
  State<Pintura> createState() => _PinturaState();
}
...
class _PinturaState extends State<Pintura> {
          ...
          TextButton(
            onPressed: () {
              setState(() {
                ...
                paintDetails = appointment['details'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agendar Cita - Pintura'),
          ...
          children: [
            ...
            TextField(
              decoration: const InputDecoration(
                labelText: 'Detalles de la pintura',
            ...
            Center(
              child: ElevatedButton(
                onPressed: () {
                  if (selectedDate != null && selectedTime != null && paintDetails != null && paintDetails!.isNotEmpty) {
